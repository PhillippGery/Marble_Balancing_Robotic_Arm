...
\title{Dynamic Spatial Stabilization and Trajectory Tracking of a Spherical Agent on a 6-DOF Robotic Platform}
	...
	\author{Phillipp Gery (pgery), Kevin Biju Mathew PUID : 039399374%
	...
	\begin{itemize}
		...
		\item \textbf{Trajectory Planning:} Development of a path planning module (e.g., quintic polynomials or Spline-based interpolation) to generate smooth, time-parameterized reference trajectories for the marble on the moving board.
