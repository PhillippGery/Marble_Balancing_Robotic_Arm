...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'urdf'),
            glob('urdf/*.sdf') + glob('urdf/*.urdf') + glob('urdf/*.xacro') + glob('urdf/*.stl')),
